...
<body
    id="body"
    class="t34"
    style="min-width:100%;Margin:0px;padding:0px;background-color:#F9F9F9;"
>
    <div
        class="t33"
    ...
    >
        ...
        >
            <tr>
                <td
                    class="t32"
                    style="font-size:0;line-height:0;mso-line-height-rule:exactly;background-color:#F9F9F9;"
                    valign="top"
                    align="center"
                >
                    <!--[if mso]>
                    ...
                    >
                        <tr>
                            <td>
                                <div
                                    class="t28"
                                    style="mso-line-height-rule:exactly;font-size:1px;display:none;"
                                >&nbsp;&nbsp;</div>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <!--[if mso]>
<table class="t30" role="presentation" cellpadding="0" cellspacing="0" align="center">
<![endif]-->
                                <!--[if !mso]>-->
                                <table
                                    class="t30"
                                ...
                                >
                                    ...
                                    <tr>
                                        <!--[if mso]>
<td class="t29" style="background-color:#FFFFFF;width:320px;padding:43px 40px 24px 40px;">
<![endif]-->
                                        <!--[if !mso]>-->
                                        <td
                                            class="t29"
                                            style="background-color:#FFFFFF;width:240px;padding:43px 40px 24px 40px;"
                                        >
                                            <!--<![endif]-->
                                            <table
                                                role="presentation"
...
<![endif]-->
                                                        ...
                                                        >
                                                            ...
                                                            <tr>
                                                                <!--[if mso]>
<td class="t10" style="width:272px;">
<![endif]-->
                                                                <!--[if !mso]>-->
                                                                <td
                                                                    class="t10"
                                                                ...
                                                                >
                                                                    ...
                                                                    <p
                                                                        class="t8"
                                                                        style="margin:0;Margin:0;font-family:Inter,BlinkMacSystemFont,Segoe UI,Helvetica Neue,Arial,sans-serif;line-height:22px;font-weight:500;font-style:normal;font-size:13px;text-decoration:none;text-transform:none;letter-spacing:-0.6px;direction:ltr;color:#424040;text-align:left;mso-line-height-rule:exactly;mso-text-raise:3px;"
                                                                    >Berikut kode OTP yang digunakan untuk <span
                                                                            class="t7"
...
<![endif]-->
                                                        ...
                                                        >
                                                            ...
                                                            <tr>
                                                                <!--[if mso]>
<td class="t14" style="background-color:#E8FFE4;overflow:hidden;width:141px;text-align:center;line-height:32px;mso-line-height-rule:exactly;mso-text-raise:5px;border-radius:8px 8px 8px 8px;">
<![endif]-->
                                                                <!--[if !mso]>-->
                                                                <td
                                                                    class="t14"
...
<![endif]-->
                                                        ...
                                                        >
                                                            ...
                                                            <tr>
                                                                <!--[if mso]>
<td class="t18" style="width:272px;">
<![endif]-->
                                                                <!--[if !mso]>-->
                                                                <td
                                                                    class="t18"
                                                                ...
                                                                >
                                                                    ...
                                                                    <p
                                                                        class="t16"
                                                                        style="margin:0;Margin:0;font-family:Inter,BlinkMacSystemFont,Segoe UI,Helvetica Neue,Arial,sans-serif;line-height:22px;font-weight:500;font-style:normal;font-size:13px;text-decoration:none;text-transform:none;letter-spacing:-0.6px;direction:ltr;color:#424040;text-align:left;mso-line-height-rule:exactly;mso-text-raise:3px;"
                                                                    >Kode diatas hanya berlaku selama 3 menit. Harap
                                                                        segera masukan kode tersebut pada aplikasi
                                                                        SukaPerpus.</p>
                                                                </td>
                                                            </tr>
                                                        </table>
...
<![endif]-->
                                                        ...
                                                        >
                                                            ...
                                                            <tr>
                                                                <!--[if mso]>
<td class="t22" style="width:272px;">
<![endif]-->
                                                                <!--[if !mso]>-->
                                                                <td
                                                                    class="t22"
                                                                ...
                                                                >
                                                                    ...
                                                                    <p
                                                                        class="t20"
                                                                        style="margin:0;Margin:0;font-family:Inter,BlinkMacSystemFont,Segoe UI,Helvetica Neue,Arial,sans-serif;line-height:22px;font-weight:500;font-style:normal;font-size:13px;text-decoration:none;text-transform:none;letter-spacing:-0.6px;direction:ltr;color:#424040;text-align:left;mso-line-height-rule:exactly;mso-text-raise:3px;"
                                                                    >Demi menjaga kerahasiaan data kamu, mohon jangan
                                                                        membagikan kode OTP ke siapapun.</p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
...
<![endif]-->
                                                        ...
                                                        >
                                                            ...
                                                            <tr>
                                                                <!--[if mso]>
<td class="t26" style="background-color:#F2EFF3;overflow:hidden;width:272px;padding:20px 30px 20px 30px;border-radius:8px 8px 8px 8px;">
<![endif]-->
                                                                <!--[if !mso]>-->
                                                                <td
                                                                    class="t26"
                                                                    style="background-color:#F2EFF3;overflow:hidden;width:180px;padding:20px 30px 20px 30px;border-radius:8px 8px 8px 8px;"
                                                                >
                                                                    <!--<![endif]-->
                                                                    <p
                                                                        class="t24"
                                                                    ...
                                                                    >Email ini dikirim secara otomatis dan harap tidak
